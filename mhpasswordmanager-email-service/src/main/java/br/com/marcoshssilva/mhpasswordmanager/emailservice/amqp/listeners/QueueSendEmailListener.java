...
public class QueueSendEmailListener {
    ...
    public void onReceiveMessage(@Payload Message message) {
        try {
            ...
            MimeMessage mimeMessage = mailMessageService.prepareSimpleMimeMessage(simpleMailMessage.getDestination(), simpleMailMessage.getSubject(), simpleMailMessage.getMessage(), false, false);
