...
docker build -t mhpasswordmanager/oauth2-authorization-server:dev ../mhpasswordmanager-oauth2-authorizationserver
if "%~1"=="" (
    docker tag mhpasswordmanager/oauth2-authorization-server:dev mhpasswordmanager/oauth2-authorization-server:%1
)
