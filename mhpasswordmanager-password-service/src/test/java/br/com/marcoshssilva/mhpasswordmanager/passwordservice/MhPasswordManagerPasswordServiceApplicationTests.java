...
class MhPasswordManagerPasswordServiceApplicationTests {
    ...
    void shouldCallSpringApplicationRun() {
        try (MockedStatic<SpringApplication> mocked = mockStatic(SpringApplication.class)) {
            ...
            mocked.when(() -> SpringApplication.run(MhPasswordManagerPasswordServiceApplication.class, args))
                    .thenReturn(null);

            MhPasswordManagerPasswordServiceApplication.main(args);

            mocked.verify(() -> SpringApplication.run(MhPasswordManagerPasswordServiceApplication.class, args));
        }
    }
