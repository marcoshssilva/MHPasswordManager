...
Certificate:
    ...
    void mustGeneratePrivateKeyFromPKCS8() {
        assertDoesNotThrow(() -> rsaUtilService.getPrivateFromPKCS8(ENCODED_KEY_PKCS8));
    }
    ...
    void mustGeneratePublicKeyFromPrivateKeyPKCS8() {
        assertDoesNotThrow(() -> rsaUtilService.getPublic(rsaUtilService.getPrivateFromPKCS8(ENCODED_KEY_PKCS8)));
    }
    ...
    void mustGeneratePrivateKeyFromPkcs8FromDecoded() {
        byte[] pkc8Key = DECODED_KEY_PKCS8.getBytes();
