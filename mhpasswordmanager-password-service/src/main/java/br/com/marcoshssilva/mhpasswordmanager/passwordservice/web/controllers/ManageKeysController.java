...
//        return ResponseEntity.ok(saved);
    ...
    public ResponseEntity<Void> deleteKey(@AuthenticationPrincipal Jwt token, @PathVariable("bucketUuid") String uuid, @PathVariable("id") Long id) throws UserRegistrationNotFoundException, KeyNotFoundException {
...
//        return ResponseEntity.status(HttpStatus.OK).build();
    ...
    public ResponseEntity<KeyStorePayloadEncodedDto> getKeyPayload(@AuthenticationPrincipal Jwt token, @PathVariable("bucketUuid") String uuid, @PathVariable("id") Long id, @PathVariable("keyStoreId") Long keyStoredId) throws UserRegistrationNotFoundException, KeyRegistrationErrorException, KeyNotFoundException {
...
//        return ResponseEntity.ok(encodedDto);
    ...
    public ResponseEntity<Void> deleteKeyPayload(@AuthenticationPrincipal Jwt token, @PathVariable("bucketUuid") String uuid, @PathVariable("keyId") Long keyId, @PathVariable("keyStoredId") Long keyStoredId) throws KeyRegistrationErrorException, UserRegistrationNotFoundException, KeyNotFoundException {
